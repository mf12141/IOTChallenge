...
trig_pin=config.pin_ultrasonic_dist_trig
echo_pin=config.pin_ultrasonic_dist_echo
...
def main():
  measure = Measurement(trig_pin,echo_pin)
  print measure.distance_metric(measure.raw_distance()),"cm"
